...
//	class _Alloc = allocator<container>>
...
//
//template<class map,
//	class _Alloc = allocator<map>>
//inline void DeleteSTLMap(map& m)
//{
//	using _Mybase = _Vector_alloc<_Vec_base_types<map, _Alloc>>;
//
//	for (_Mybase::iterator it = m.begin(); it != m.end(); ++it)
//	{
//		delete it->second;
//		it->second = NULL;
//	}
